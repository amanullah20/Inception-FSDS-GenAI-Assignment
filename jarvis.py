...
def takeCommand():
    """This function take command and recognize
...
while True:
   ...
   if "your name" in query:
       ...
       logging.info("User asked for correct time") 
      ...
      # YouTube search
       ...
       speak("ok sir . please type here what do you want ")
       webbrowser.open("https://www.linkedin.com") 
       logging.info("User requested to open Linkedin") 

   elif "exit" in query:
       speak("Thank yor for your time sir. Have a great day ahead!")
       exit()

   else:
       speak("I am sorry , I con't help you with that.") 
